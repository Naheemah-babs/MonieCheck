...
//     const prompt = `
// You are a financial advisor for Nigerian SMEs at Moniepoint, a leading fintech company.
...
// - Moniepoint account age: ${formData.accountAge}
...
// Example format:
// [{"title":"Register with CAC now","detail":"Your unregistered status is your biggest limiting factor. Registration typically unlocks 40–60% higher loan limits at Moniepoint."},{"title":"...","detail":"..."}]
//     `.trim()
